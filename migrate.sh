#!/bin/sh
#
#    EcoPos Touch Friendly Point of Sale designed for Touch Screen
#    Copyright (c) 2009-2014 EcoPos & previous Openbravo POS works
#    http://sourceforge.net/projects/ecopos
#
#    This file is part of EcoPos.
#
#    EcoPos is free software: you can redistribute it and/or modify
#    it under the terms of the GNU General Public License as published by
#    the Free Software Foundation, either version 3 of the License, or
#    (at your option) any later version.
#
#    EcoPos is distributed in the hope that it will be useful,
...
# Linux script to start migrate of ecopos
#
DIRNAME=`dirname $0`
CP=$DIRNAME/ecopos.jar
