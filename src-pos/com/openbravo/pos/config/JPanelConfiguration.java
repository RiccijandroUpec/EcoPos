...
// JG 24 Oct 13 - Add Peripheral tab
    ...
    private void initComponents() {
        ...
        jTabbedPane1.addTab(AppLocal.getIntString("Tab.DatabaseSetup"), jPanelDatabase);
        ...
        jTabbedPane1.addTab(AppLocal.getIntString("Tab.General"), jPanelGeneral);
        ...
        jTabbedPane1.addTab(AppLocal.getIntString("Tab.Locale"), jPanelLocale);
        ...
        jTabbedPane1.addTab(AppLocal.getIntString("Tab.PaymentMethod"), jPanelPayment);
        ...
        jTabbedPane1.addTab(AppLocal.getIntString("Tab.Peripherals"), jPanelPeripheral);
        ...
        jTabbedPane1.addTab(AppLocal.getIntString("Tab.SystemOptions"), jPanelSystem);
        ...
        jTabbedPane1.addTab(AppLocal.getIntString("Tab.TicketSetup"), jPanelTicketSetup);
